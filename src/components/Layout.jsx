    ...
    <div>
      ...
      <div className="wrap">
        ...
        <p className="footnote warn" style={{ marginTop: 30 }}>
          ...
          {' '}<b>On write-ups:</b> game, storyline, and playoff-scenario blurbs are generated by
          Claude from the real data shown above; if generation fails, a plain deterministic
          sentence built from the same facts is used instead.
        </p>
      </div>
    </div>
  );
